...
namespace TestGenerator.Migrations
{
    ...
    [Migration("20250219184641_AddImagePathToQuestion")]
    partial class AddImagePathToQuestion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestGenerator.Models.Answer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Content = "A way to organize code into logical groups",
                            IsCorrect = true,
                            QuestionId = 1
                        },
                        new
                        ...
                        {
                            Id = 5,
                            Content = "First() throws an exception if no elements found, FirstOrDefault() returns default value",
                            IsCorrect = true,
                            QuestionId = 3
                        },
                        new
                        {
                            Id = 6,
                            Content = "They are exactly the same",
                            IsCorrect = false,
                            QuestionId = 3
                        },
                        new
                        {
                            Id = 7,
                            Content = "FirstOrDefault() is faster than First()",
                            IsCorrect = false,
                            QuestionId = 3
                        },
                        new
                        {
                            Id = 8,
                            Content = "First() returns null, FirstOrDefault() throws an exception",
                            IsCorrect = false,
                            QuestionId = 3
                        });
                });
